...
var faceStructure = {
    ent_video_0: [  new THREE.Vector3( 240,  240, -240),   new THREE.Vector3(240,  240,    0),
            ...
            new THREE.Vector3( 240,  200, -200),   new THREE.Vector3(240,  200,    0),
            new THREE.Vector3( 240,  200,  200),   new THREE.Vector3(240,    0,  200),
            new THREE.Vector3( 240, -200,  200),   new THREE.Vector3(240, -200,    0),
            new THREE.Vector3( 240, -200, -200),   new THREE.Vector3(240,    0, -200),
            new THREE.Vector3( 240 ,   0,   0),
    ...
    ent_video_2: [  new THREE.Vector3(-240,  240, -240),   new THREE.Vector3(   0,    240, -240),
            ...
            new THREE.Vector3(-200,   240, -200),   new THREE.Vector3(   0,    240, -200),
            new THREE.Vector3( 200,   240, -200),   new THREE.Vector3( 200,     240,    0),
            new THREE.Vector3( 200,   240,  200),   new THREE.Vector3(   0,    240,  200),
            new THREE.Vector3(-200,   240,  200),   new THREE.Vector3(-200,     240,    0),
            new THREE.Vector3(   0,  240,   0),
    ...
    ent_video_4: [  new THREE.Vector3(-240,  240, -240),   new THREE.Vector3(   0,   240,  -240),
            ...
            new THREE.Vector3(-200,  200, -240),   new THREE.Vector3(   0,   200,  -240),
            new THREE.Vector3( 200,  200, -240),   new THREE.Vector3( 200,     0,  -240),
            new THREE.Vector3( 200, -200, -240),   new THREE.Vector3(   0,  -200,  -240),
            new THREE.Vector3(-200, -200, -240),   new THREE.Vector3(-200,     0,  -240),
            new THREE.Vector3(   0,  0, -240),
